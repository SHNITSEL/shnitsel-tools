...
def normalize(a: DataArrayOrVar, dim='direction') -> DataArrayOrVar:
    ...
    Returns:
        xr.DataArray | xr.Variable: Resulting DataArray after calculation of the noramlized vectors in the dimension `dim`.
    """
...
def angle_cos_sin_(
    ...
    Returns:
        tuple[DataArrayOrVar, DataArrayOrVar]: First the vector of cosines, second the vector of sines.
    """
