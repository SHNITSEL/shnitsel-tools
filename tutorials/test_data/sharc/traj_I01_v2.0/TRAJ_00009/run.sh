#$ -v USER_EPILOG=Singlet_2/TRAJ_00009//epilog.sh


PRIMARY_DIR=/user/anna/Bachelor/Methylenimmonium/Trajectories/Singlet_2/TRAJ_00009/
COPY_DIR=$TMPDIR/Singlet_2/TRAJ_00009/
