...
def main():
    try:
        ...
        from shnitsel.geo import geocalc, geocalc_, alignment  # , geomatch_exact
    ...
    da_funcs = [
        ...
        ### clean
        clean.common.true_upto,
        ### geom
        geocalc_.dihedrals.dihedral,
    ...
    ds_funcs = [
        ...
        clean.common.omit,
        clean.common.truncate,
        clean.common.transect,
        ### ase
        write_ase_db,
        ### ml
        pls.pls_ds,
